...
import digital_twin from "../../Assets/Projects/digital_twin.png"
    ...
    <Container fluid className="project-section">
      ...
      <Container>
        ...
        <Col md={4} className="project-card">
            <ProjectCard
              imgPath={digital_twin}
              isBlog={false}
              isGithub={false}
              title="Software Test Automation"
              description="This is the current project at Nokia where I am developing Test Automation Framework in radish which is BDD(behavior driven Development). It is for a product which provides a software service to digital twin(i.e. copy) the customer's existing network into containerized network topology. My role is to test this service, write test scenarios & features."
            />
          </Col>
        <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="This is the project at Nokia which I did during my co-op. Nuage SD-WAN portal contains different networking apps with various features. My role was developing the automation scripts, defining the scenarios and steps for automation and test it with developed radish framework. Improved software quality by validating the defects."
            />
          </Col>
          <Col md={4} className="project-card">
            <ProjectCard
